...
/**
 * Servlet implementation class musicPostController
 */
@WebServlet("/mpost")
public class musicPostController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public musicPostController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<Item2> itemm = repo.list(page);
		...
		RequestDispatcher view = request.getRequestDispatcher("/WEB-INF/mpost.jsp");
